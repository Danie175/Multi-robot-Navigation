...
class MergeMapNode(Node):
    def __init__(self):
        ...
        # Update the subscriptions to use the namespaced map topics
        self.subscription1 = self.create_subscription(OccupancyGrid, 'robot1/map', self.map1_callback, 10)
        self.subscription2 = self.create_subscription(OccupancyGrid, 'robot2/map', self.map2_callback, 10)
